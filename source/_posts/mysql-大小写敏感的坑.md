...
cover: /images/2023/01/caspar-camille-rubin-fPkvU7RDmCo-unsplash-scaled.jpg
coverWidth: 1200
coverHeight: 600
---
...
[![](/images/2023/01/image.png)](/images/2023/01/image.png)
...
[![](/images/2023/02/image.png)](/images/2023/02/image.png)

Google 登录：自动转换

[![](/images/2023/02/image-1.png)](/images/2023/02/image-1.png)


在输入正确的邮箱后，输入密码时，原来大写的邮箱会被自动转换成小写，当然，对于邮箱来说是这样，因为邮箱本身就不区分大小写。（如果有网站的数据库区分了邮箱的大小写，那理论上，通过修改大小写组合，一个邮箱可以注册很多次）

[![](/images/2023/02/image-2.png)](/images/2023/02/image-2.png)

_其实Gmail同时还会忽略.+等字符，也就是你的邮箱中间可以加点或者加号等，感兴趣的可以搜索Google别名邮箱_

### 那么 Github 呢

[![](/images/2023/02/image-4.png)](/images/2023/02/image-4.png)
...
[![](/images/2023/02/image-6.png)](/images/2023/02/image-6.png)

不一样的字符

[![](/images/2023/02/image-5.png)](/images/2023/02/image-5.png)
